...
function ListaFornecedores() {
  ...
  const columns = [
    ...
    { field: 'nome_contato', header: 'Contato principal' },
    { field: 'telefone_contato', header: 'Telefone contato' },
    { field: 'email_contato', header: 'Email' }
  ...
  const exportExcel = () => {
    import('xlsx').then(xlsx => {
      ...
      saveAsExcelFile(excelBuffer, 'lista_fornecedores');
    });
  }
  ...
  //rodapé
  const footer = `Total de ${registros ? registros.length : 0} fornecedores.`;
  ...
  const onSubmit = (formContent) => {
    ...
    if (formContent.nome.trim()) {
      ...
      if (_registro.id) {
        ...
        axiosApi.patch("/fornecedores", formContent)
          .then((response) => {
            _registro.data_nascimento = '01-01-2024';// preciso mudr formato do date aqui, posso pegar o vindo do post
        ...
        axiosApi.post("/fornecedores", formContent)
          .then((response) => {
  ...
  const deleteregistro = () => {
    axiosApi.delete("/fornecedores/" + registro.id)
      .then((response) => {
  ...
  return (
    <>
      ...
      <Sidebar className='w-sidebar-right' header={<h3>Cadastro fornecedores</h3>} visible={visibleRight} position="right" blockScroll onHide={() => setVisibleRight(false)} style={{ width: '30em' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-fluid w-form" >
            ...
            <div className="p-fluid grid">
              <div className="field w-field col-12 md:col-12">
                <label class="font-medium text-900">Nome empresarial:</label>
              ...
              <div className="field w-field col-12 md:col-12">
                <label class="font-medium text-900">Contato de referência:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-user"></i>
                  </span>
                  <InputText {...register("nome_contato")} />
                </div>
              </div>
              <div className="field w-field col-12 md:col-12">
                <label class="font-medium text-900">Telefone de referência:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-whatsapp"></i>
                  </span>
                  <InputMask id="telefone" mask={'(99) 9 9999-9999'} {...register("telefone_contato")} />
                </div>
              </div>
              <div className="field w-field col-12 md:col-12">
                <label class="font-medium text-900">Email de referência:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-send"></i>
                  </span>
                  <InputText  rows={3} cols={30} autoResize {...register("email_contato")} />
                </div>
              </div>
