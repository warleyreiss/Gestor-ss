...
function ListaTickets(props) {
  ...
  return (
    <>
      ...
      <Sidebar header={selectedProducts.length + " Tickets selecionados"} visible={visibleCRUD} position="bottom"  onHide={() => closedNew()} modal={false} dismissable={false} closeOnEscape={false} ariaCloseLabel={'open'}>
        <FormCru registro={selectedProducts} filhoParaPaiPost={recebidoDoFilhoPost} filhoParaPaiPatch={recebidoDoFilhoPatch} />
      </Sidebar>
      <Toast ref={toast} />
      <div className="card">
