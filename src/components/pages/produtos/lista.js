...
function ListaProdutos() {
  ...
  const columns = [
    ...
    { field: 'referencia', header: 'Cód./referência' },
    { field: 'nome', header: 'Nome' },
    { field: 'estoque_ideal', header: 'Ideal' },
    { field: 'estoque_atual', header: 'Atual' },
    { field: 'preco_custo', header: 'Preço_custo' },
    { field: 'preco_venda', header: 'Preço_venda' }
  ];
  ...
  const onSubmit = (formContent) => {
    ...
    if (formContent.nome.trim()) {
      ...
      if (_registro.id) {
        ...
        axiosApi.patch("/produtos", formContent)
          .then((response) => {
        ...
        axiosApi.post("/produtos", formContent)
          .then((response) => {
  ...
  const deleteregistro = () => {
    axiosApi.delete("/produtos/" + registro.id)
      .then((response) => {
  ...
  return (
    <>
      ...
      <Sidebar className='w-sidebar-right' header={<h3>Cadastro de produtos</h3>} visible={visibleRight} position="right" blockScroll onHide={() => setVisibleRight(false)} style={{ width: '30em' }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-fluid w-form" >
            ...
            <div className="p-fluid grid">
              ...
              <div className="field w-field col-12 md:col-12">
                <label class="font-medium text-900">Nome do produto:</label>
              ...
              <div className="field w-field col-12 md:col-12">
                ...
                <div className="p-inputgroup">
                  ...
                  <InputText  {...register("referencia")} />
                </div>
              </div>
              <div className="field w-field col-6 md:col-6">
                <label class="font-medium text-900">Estoque ideal:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-sort-numeric-up"></i>
                  </span>
                  <InputText {...register("estoque_ideal")} />
                </div>
              </div>
              <div className="field w-field col-6 md:col-6">
                ...
                <div className="p-inputgroup">
                  ...
                  <InputText {...register("estoque_atual")} />
                </div>
              </div>
              <div className="field w-field col-6 md:col-6">
                <label class="font-medium text-900">Preço custo:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-money-bill"></i>
                  </span>
                  <InputText {...register("preco_custo")} />
                </div>
              </div>
              <div className="field w-field col-6 md:col-6">
                <label class="font-medium text-900">Preço venda:</label>
                <div className="p-inputgroup">
                  <span className="p-inputgroup-addon">
                    <i className="pi pi-money-bill"></i>
                  </span>
                  <InputText {...register("preco_venda")} />
                </div>
              </div>
              <div className="field w-field col-12 md:col-12">
      ...
      <Dialog visible={deleteregistroDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteregistroDialogFooter} onHide={hideDeleteregistroDialog}>
        <div className="confirmation-content">
          ...
          {registro && <span>Você deseja realmente excluir? <b>{registro.name}</b></span>}
        </div>
      </Dialog>
    </>
