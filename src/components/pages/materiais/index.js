...
function Materiais() {
  ...
  const nomePagina = 'Cadastros de equipamentos'
  ...
  const buscarRegistros2 = () => {
    setLoading(true);
    axiosApi.get("/list_equipment_accept")
      .then((response) => {
        setRegistrosAccepts(response.data)
      })
      .catch(function (error) {
      });
    setLoading(false)
  ...
  const columns = [
    ...
    { field: 'tipo', header: 'Tipo de equipamento:' },
    { field: 'numero_serie', header: 'Número de série:' },
  ...
  const actionBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
        <Button icon="pi pi-pencil" className="p-button-outlined p-button-info" onClick={e => { editeRegistro(rowData) }} />
  ...
  return (
    <>
      ...
      <Sidebar className='w-sidebar-right' header={<h3>{nomePagina.toUpperCase()}</h3>} visible={visibleCRUD} position="right" blockScroll onHide={() => closedNew()} style={{ width: '100em' }}>
        <FormCru registro={registro} filhoParaPaiPost={recebidoDoFilhoPost} filhoParaPaiPatch={recebidoDoFilhoPatch} />
      </Sidebar>
      <Toast ref={toast} />
      <div className="card">
      ...
      <Sidebar className='w-sidebar-right w-sidebar-right-menu ' header={<h3>O que gostaria de fazer?</h3>} visible={visibleMenuRight} position="right" blockScroll onHide={() => setVisibleMenuRight(false)} style={{ width: '550px' }}>
        <div className="card w-card" >
          ...
          <div className="grid p-card-grid">
            ...
            <div className="col-fixed p-card-grid-col">
              <Link className='p-card-grid-col-link'  >
                <div className="grid nested-grid p-card-grid-col-link-grid">
                  <div className="grid p-card-grid-col-link-grid-grid">
                    <div className="col-10 p-card-grid-col-link-grid-grid-title">
                    ...
                    <div className="col-12 p-card-grid-col-link-grid-grid-desc">
                      Visualize todos equipamento cadastrados
                    </div>
                  </div>
                </div>
              </Link>
            ...
            <div className="col-fixed p-card-grid-col">
              <Link className='p-card-grid-col-link'  >
                <div className="grid nested-grid p-card-grid-col-link-grid">
                  <div className="grid p-card-grid-col-link-grid-grid">
                    <div className="col-10 p-card-grid-col-link-grid-grid-title">
                      Atendimento à chamados
                    </div>
                    <div className="col-2 p-card-grid-col-link-grid-grid-icon">
                      <i className="pi pi-bell"></i>
                    </div>
                    <div className="col-12 p-card-grid-col-link-grid-grid-desc">
                      Registre atendimento á chamados/solicitações de materiais
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link className='p-card-grid-col-link' >
                <div className="grid nested-grid p-card-grid-col-link-grid">
                  <div className="grid p-card-grid-col-link-grid-grid">
                    ...
                    <div className="col-12 p-card-grid-col-link-grid-grid-desc">
                      Visualize seu estoque de materiais dividido por almoxarifado e responsável
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <div className="grid nested-grid p-card-grid-col-link-grid">
                <div className="grid p-card-grid-col-link-grid-grid">
                  ...
                  <Inplace closable className='p-inplace-mini-form'>
                    <InplaceDisplay>
                      {<div className="col-12 p-card-grid-col-link-grid-grid-desc" >
                        Liste todo extrato de informações referente aos chamados atendidos
                      </div>}
                    </InplaceDisplay>
                    <InplaceContent className='ola'>
                      <FormHistorico url={'/historico_chamados'} />
                    </InplaceContent>
                  </Inplace>
                </div>
              </div>
              ...
              <Link className='p-card-grid-col-link'  >
                <div className="grid nested-grid p-card-grid-col-link-grid">
                  <div className="grid p-card-grid-col-link-grid-grid">
                    ...
                    <div className="col-12 p-card-grid-col-link-grid-grid-desc">
                      Faça entradas de materiais vindos de clientes
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link className='p-card-grid-col-link'  >
                <div className="grid nested-grid p-card-grid-col-link-grid">
                  <div className="grid p-card-grid-col-link-grid-grid">
                    ...
                    <div className="col-12 p-card-grid-col-link-grid-grid-desc">
                      Ajuste e controle equiapmentos e almoxarifados manualmente
                    </div>
                  </div>
                </div>
              </Link>
