          ...
          <div className='w-os-body-gridConteudo'>
            <div className="grid">
              <div className="col-10">
                <Accordion activeIndex={0} className='w-os-body-gridConteudo-accordion'>
                  ...
                  <AccordionTab header="Serviços realizados" className=''>
                    <ListaServicos ReceberPropsfilhoServicos={objListaServicosSelecionados} id={inPreview.id} />
                  </AccordionTab>
                  <AccordionTab header="Pagamentos recebidos" className=''>
